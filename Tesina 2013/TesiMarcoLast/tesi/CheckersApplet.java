...
public class CheckersApplet extends JApplet {
   ...
   public void init() {
      ...
      whiteChecker = new ImageIcon("images/white.gif");
      blackChecker = new ImageIcon("images/black.gif");
      whiteKingChecker = new ImageIcon("images/whiteKing.gif");
      blackKingChecker = new ImageIcon("images/blackKing.gif");
